...
define( "RHD_GOOGLE_FONTS", 'Open+Sans+Condensed:300,700|Open+Sans:400,700,400italic' );
...
function rhd_is_mobile()
{
	...
	if ( !empty( $_SERVER['HTTP_ACCEPT'] ) && ( strpos( strtolower( $_SERVER['HTTP_ACCEPT'] ),'application/vnd.wap.xhtml+xml' ) > 0 ) or ( ( isset( $_SERVER['HTTP_X_WAP_PROFILE'] ) or isset( $_SERVER['HTTP_PROFILE'] ) ) ) ) {
	    ++$mobile_browser;
	}
