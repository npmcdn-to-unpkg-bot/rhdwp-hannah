...
function rhd_enqueue_styles()
{
	...
	wp_register_style( 'google-fonts', '//fonts.googleapis.com/css?family=Lato:300,400,700,400italic' );
...
function rhd_add_editor_styles()
{
	...
	$font_url = '//fonts.googleapis.com/css?family=Lato:300,400,700,400italic';
